        ...
        <div class="bg-white bg-opacity-90 shadow-lg mx-auto w-full max-w-[700px] p-12 rounded-2xl">
            <div class="text-center mb-8">
                ...
                <?php if ($insert_success): ?>
                    ...
                    <p class="mb-5 text-base text-[#6B7280]">
                        Merci pour vos réponses ! Nous sommes ravis d’avoir pu vous accompagner lors de cet événement d’orientation. Vos retours sont précieux pour nous aider à améliorer chaque édition. Nous avons hâte de vous retrouver lors de nos prochains événements ! <br> Pour plus d'informations rendez-vous sur notre site : <a href="https://www.lycee-louis-vincent.fr/"><span class="underline">https://lycee-louis-vincent.fr</span></a> <br> Vous souhaitez nous contacter ? Cliquez juste  <a href="mailto:email@example.com?subject=Demande d'informations&body=Bonjour,"> <span class="underline">ici</span></a> !
                    </p>
                <?php endif; ?>
